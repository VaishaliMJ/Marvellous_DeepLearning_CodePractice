...
def main():
    ...
    print(f"{h1_output} * {w_out1} + {h2_output}*{w_out2} + {b_out}")
    ...
    displayGraphics([x1,x2,w11,w12,b1,h1_output,w21,w22,b2,h2_output,w_out1,w_out2,b_out,final_output])
#####################################################################################################
...
def displayGraphics(params):
    ...
    plt.text(0.95, 2, f"x1\n{params[0]}", ha='center', va='center', fontsize=10)
    plt.text(0.95, 1, f"x2\n{params[1]}", ha='center', va='center', fontsize=10)  
    
    plt.text(3, 2.5, f"h1\n{params[5]}", ha='center', va='center', fontsize=10)
    plt.text(3, 0.5, f"h2\n{params[9]}", ha='center', va='center', fontsize=10)
  
    plt.text(5, 1.5, f"y\n{params[13]:.3f}", ha='center', va='center', fontsize=10)

    #label Biases
    plt.text(3, 2.3, f"b1\n{params[4]}", ha='center', va='center', fontsize=10)
    plt.text(3, 0.7, f"b2\n{params[8]}", ha='center', va='center', fontsize=10)
    plt.text(5, 1.7, f"b_out\n{params[12]}", ha='center', va='center', fontsize=10)
    ...
    # Weight labels
    plt.text(1.8, 2.3, f"w11={params[2]}", fontsize=9)
    plt.text(1.8, 1.3, f"w12={params[3]}", fontsize=9)
    plt.text(1.8, 1.8, f"w21={params[6]}", fontsize=9)
    plt.text(1.8, 0.8, f"w22={params[7]}", fontsize=9)

    plt.text(4, 2.2, f"w_out1={params[10]}", fontsize=9)
    plt.text(4, 1.0, f"w_out2={params[11]}", fontsize=9)

    plt.title(label="Artificial Neural Network Structure with Values")
    plt.axis('off')
    plt.show()    
#####################################################################################################    
